            ...
            <Wrapper>
                ...
                >
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div>yashrajkanake2002@gmail.com</div>
                    </div>
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Yashraj Kanake</span>
                    </div>
                    <div className="max-w-[510px]">
                        I create and maintain modern websites and applications.I solve all your business problems including Problem solving, Editing Images and Maintaining the good working envioronment.
                        {/*  Lorem Ipsum is
                ...
                {/* PERSON BLOCK START */}
                <motion.div
                    className="absolute bottom-0 left-[50%] height-[100vh] w-full  flex justify-around"
                    initial={{ y: 200, x: "-50%" }}
                    animate={{ y: 0 }}
                    transition={{ duration: 0.5 }}
                >
                    <img src={man} alt="" className="w-[300px] md:w-[360px] 2xl:w-[475px]"/>
